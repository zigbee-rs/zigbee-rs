...
/// Commissioning modes as per BDB Spec Section 5.2.1.
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum CommissioningMode {
    /// Network Steering (Section 5.2.2)
    NetworkSteering,
    /// Network Formation (Section 5.2.3)
    NetworkFormation,
    /// Finding & Binding (Section 5.2.4)
    FindingBinding,
    /// Touchlink (Section 5.2.5)
    Touchlink,
}
